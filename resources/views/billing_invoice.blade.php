...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title> {{ __('Billing Invoice - MH John') }} </title>
        ...
        <div class="invoice-header">
            <div class="invoice-flex-contents">
                <div class="invoice-logo">
                    <img src="{{ public_path('img/logo.jpg') }}" alt="Company Logo">
                </div>
            ...
            <div class="invoice-details-flex">
                <div class="invoice-single-details">
                    ...
                    <ul class="details-list">
                        <li class="list"> {{ __('Mehedi Hasan') }} </li>
                        <li class="list"> <a href="#">john@gmail.com </a> </li>
                        <li class="list"> <a href="#"> 01982638571</a> </li>
                    </ul>
                </div>
        ...
        <div class="item-description">
            <div class="table-responsive">
                ...
                <table class="custom--table">
                    ...
                    <tr>
                        <td>
                            <span class="data-span"> {{ __('Name: ') }}</span>{{ __('John') }} <br>
                            <span class="data-span"> {{ __('Email: ') }}</span>fake@gmail.com <br>
                            <span class="data-span"> {{ __('Phone: ') }}01987264513 <br>
